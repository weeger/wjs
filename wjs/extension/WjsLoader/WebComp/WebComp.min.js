...
b.type=a;b.loader=this;b.pack=e;b.classExtends=b.hasOwnProperty("classExtends")?b.classExtends:this.protoBaseClass;this.wjs.classExtend(f,b);if(b.hasOwnProperty("bundle"))for(c=Object.keys(b.bundle),d=0;d<c.length;d++)this.addCreatorItem(a+"."+c[d],b.bundle[c[d]],e);return this.wjs.classMethods[f]},instance:function(a,b){var c=this.wjs,d=this.protoName(a);c.classMethods[d]||c.err("Prototype not found for "+d);b=b||c.get(this.type,a)||{};b.loader=this;this.instancesCount[a]=(this.instancesCount[a]||
0)+1;return new (c.classProto(d))(b)},instanceDestroy:function(a){0===--this.instancesCount[a.type]&&delete this.instancesCount[a.type]}})})(WjsProto);