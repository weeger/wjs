...
(function(f){var l;if(void 0===f.wjs||"3.3.4"!==f.wjs.version)l=function(){this.extendObject(this,{context:f,window:f.window||window,document:f.document||window.document,version:"3.3.4",readyCallbacks:[],readyComplete:!1,packageDefault:null,loaders:{},loadersExtra:[],loadersBasic:[],extLoaded:{WjsLoader:{}},extRequire:{},processProto:null,processes:[],classProtos:{},classMethods:{},destroyQ:[],cacheBuffer:{},settings:null,linkReg:/^wjs:\/\/([a-zA-Z0-9]*):([a-zA-Z0-9]*)$/});this.context.wjsContext=
f},l.prototype={init:function(a){var b=this;this.window.addEventListener("load",function(){b.extendObject(b,a);for(var c=0;c<b.loadersBasic.length;c++)b.loaderAdd(b.loadersBasic[c],void 0,!0);b.ready(function(){b.linksInit(b.document.body)});(new b.processProto({complete:function(){delete b.packageDefault;b.readyComplete=!0;b.callbacks(b.readyCallbacks)}})).responseParse(b.packageDefault)})},ready:function(a){!0===this.readyComplete?this.window.setTimeout(function(){a()}):this.readyCallbacks.push(a)},
callbacks:function(a,b){for(var c=0;c<a.length;c++)a[c].apply(this,b)},linksInit:function(a){a=a.querySelectorAll('a[href^="wjs://"]');for(var b=0,c,d=function(){return!1};b<a.length;b++)c=a[b].getAttribute("href"),a[b].setAttribute("href","#"),a[b].onclick=d,a[b].setAttribute("data-wjs-link",c),a[b].addEventListener("click",this.linksClick.bind(this))},linksClick:function(a){var b=this,c=a.target.getAttribute("data-wjs-link").match(b.linkReg);b.loadersExists(c[1],function(){b.loaders[c[1]].link(c[2])});
...
if(!0===b)this.wjs.loaderAdd(a);else return this.wjs.loaders.JsLink.parse.apply(this,[a,b,c])}},!0)})(window);
