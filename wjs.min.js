...
(function(g){var n;if(void 0===g.wjs||"3.3.9"!==g.wjs.version)n=function(){this.extendObject(this,{context:g,window:g.window||window,document:g.document||window.document,version:"3.3.9",readyCallbacks:[],readyComplete:!1,packageDefault:null,loaders:{},loadersExtra:[],loadersBasic:[],extLoaded:{WjsLoader:{}},extRequire:{},processProto:null,processes:[],processCounter:0,processStack:[],processParent:void 0,classProtos:{},classMethods:{},cacheBuffer:{},cacheReg:{},settings:null});this.context.wjsContext=
