...
(function(g){var n;if(void 0===g.wjs||"3.3.5"!==g.wjs.version)n=function(){this.extendObject(this,{context:g,window:g.window||window,document:g.document||window.document,version:"3.3.5",readyCallbacks:[],readyComplete:!1,packageDefault:null,loaders:{},loadersExtra:[],loadersBasic:[],extLoaded:{WjsLoader:{}},extRequire:{},processProto:null,processes:[],processCounter:0,processStack:[],processParent:void 0,classProtos:{},classMethods:{},cacheBuffer:{},cacheReg:{},settings:null,linkReg:/^wjs:\/\/([a-zA-Z0-9]*):([a-zA-Z0-9]*)$/});
...
a){var c=!1,d=function(){c=!0;b.removeEventListener("load",d);a()};b.addEventListener("load",d);this.window.setTimeout(function(){c||a()},200)},err:function(b,a){if(!a&&this.window.console)this.window.console.error("[wjs error] : "+b);else throw new this.window.Error("[wjs error] : "+b);}},g["wjs-3.3.5"]=new n,g.wjs||(g.wjs=g["wjs-3.3.5"]),g.wjs.classExtend("WjsLoader",{type:"",preventReload:!0,processType:"server",__construct:function(){this.cacheHandler={}},__destruct:function(){},init:function(){},
