...
(function(f){var l;if(void 0===f.wjs||"3.3.3"!==f.wjs.version)l=function(){this.extendObject(this,{context:f,window:f.window||window,document:f.document||window.document,version:"3.3.3",readyCallbacks:[],readyComplete:!1,packageDefault:null,loaders:{},loadersExtra:[],loadersBasic:[],extLoaded:{WjsLoader:{}},extRequire:{},processProto:null,processes:[],classProtos:{},classMethods:{},destroyQ:[],cacheBuffer:{},settings:null});this.context.wjsContext=f},l.prototype={init:function(a){var b=
