...
(function (context) {
   ...
   */
  context.wjs.loaderAdd('DemoPage', {
    classExtends: 'WjsLoaderWebPage',
    ...
    __construct: function () {
      var wjs = this.wjs, document = wjs.document;
      ...
      this.wjs.extendObject(this, {
        ...
        domMainContent: document.getElementById('main-content'),
    ...
    buttonInit: function (name) {
      if (this.pageData[name]) {
        this.domButtons[name].classList.remove('disabled');
      }
      else {
        this.domButtons[name].classList.add('disabled');
      }
    },
