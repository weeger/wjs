...
this.domStyle,e=Object.keys(b);d<e.length;d++)this.cssRewrite(a,c,b[e[d]])},cssRewrite:function(a,c,d){d.innerHTML=d.innerHTML.replace(RegExp("\\."+a+"(?=[\\s*|{|,|.|-|:])","g"),"."+c);this.cssSheetLoadQueueAppend(d)}})})(W);
