...
(a.loader.pageInstances=a.createInstances(c));a.loader.pageRequireStatic=b}},require:{defaults:!1,define:function(a,b,c){a.optionApply("requireStatic",c);this.__super("define",[a,b,c])}},dom:{define:function(a,b,c){"WJS5_PUSH_WEBPAGE_PRELOADED"===c.html&&(c.domImported=!0,a.optionApply("domImported",c),b=this.wjs.document.getElementById(a.type+"-preloaded"),b.style.display=null);a=this.__super("define",[a,b,c]);this.wjs.wjsHrefInit(a);return a}},html:{define:function(a,b,c){a.optionApply("dom",c);
"WJS5_PUSH_WEBPAGE_PRELOADED"!==b?this.__super("define",[a,b,c]):(b=a.dom.getElementsByClassName("html")[0],a.options.html.valuePreloaded=b.innerHTML,a.domChildAdd("html",b))},destroy:function(a,b){"WJS5_PUSH_WEBPAGE_PRELOADED"!==a.html?this.__super("destroy",[a,b]):(this.wjs.extLoaded[a.loader.type][a.type].html=a.options.html.valuePreloaded,this.wjs.destroy(a.loader.type,a.type))}}},__construct:function(){this.loader.pageCurrent=this;this.__super("__construct",arguments);this.initWebPage();this.wjs.callbacks(this.loader.pageReadyCallbacks);
this.loader.pageReadyCallbacks=[];this.loader.pageShowLast=void 0},__destruct:function(){this.exitWebPage();this.loader.pageCurrent=!1;this.__super("__destruct",arguments)},initWebPage:f._e,exitWebPage:f._e})})(W);
