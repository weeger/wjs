...
b).lowerBounds;g<h.length-1;g++){var f=h[g][0],k=h[g][1],m=h[g+1][0],p=h[g+1][1];if(d>=f&&d<=m){g=(p-k)/(m-f);d=g*d+(k-g*f);break a}}d=0}f=100;switch(e.luminosity){case "dark":f=d+20;break;case "light":d=(f+d)/2;break;case "random":d=0,f=100}e=n.call(this,[d,f]);return s.call(this,[b,c,e],a)})})(WjsProto);